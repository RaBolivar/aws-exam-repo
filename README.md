...
aws --endpoint-url=http://127.0.0.1:4566 s3api put-bucket-cors --bucket exam-bucket --cors-configuration '{"CORSRules":[{"AllowedOrigins":["*"],"AllowedMethods":["GET","POST","PUT","DELETE"],"AllowedHeaders":["*"],"ExposeHeaders":[]}]}'
